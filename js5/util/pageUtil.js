...
drill.define(function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(load) {
        var _ref2, _ref3, animateUtil, commonData, isInitAnimeStyle, util;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return load("util/animateUtil", "common/data");
                    ...
                    case 2:
                        ...
                        util = {
                            // 初始化页面动画样式
                            initAnimeStyle: function initAnimeStyle() {
                                if (isInitAnimeStyle) {
                                    return;
                                }
                                isInitAnimeStyle = 1;
                                ...
                                // 添加animation style
                                var animateCSSStr = animateUtil.animationToStr();
