...
drill.define(function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(load) {
        var _ref2, _ref3, getTransformStr, commonData, isRunAnime, util;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return load("util/getTransformStr", "common/data");
                    ...
                    case 2:
                        ...
                        _context.t0 = function toPage(pageId) {
                            ...
                            // 获取激活中的页面
                            var activePage = $('.main .page[active="1"]');
                            var activeId = activePage.index();

                            // 获取下一页
                            var nextPage = $('.main .page').eq(pageId);
